  ...
  return (
    <div className="px-4 py-5 sm:px-7 sm:py-8 flex flex-col gap-5 max-w-[1400px] mx-auto">
      <div className="flex flex-col gap-[5px]">
        ...
        <h1 className="m-0 font-display font-extrabold text-[20px] text-ink">Hangar — Client dashboard</h1>
        <p className="m-0 text-[12.5px] text-muted max-w-[66ch]">
          One workspace-wide dashboard, shown to every client on their portal. Hangar has no per-client data by
