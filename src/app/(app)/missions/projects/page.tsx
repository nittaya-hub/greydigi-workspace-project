    ...
    <div className="px-4 py-5 sm:px-7 sm:py-8 flex flex-col gap-6 max-w-[1400px] mx-auto">
      <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-5">
        ...
        <div className="flex gap-1.5 flex-none">
          ...
          <ExportPdfButton href="/missions/projects/pdf" fallbackFilename={`projects-${new Date().toISOString().slice(0, 10)}.pdf`} />
          ...
          <>
            ...
            {projects.map((p, i) => (
              <TableRow cols={COLS} key={p.id} last={i === projects.length - 1}>
                ...
                <Link href={`/missions/projects/${p.ref.toLowerCase()}`} className="min-w-0">
