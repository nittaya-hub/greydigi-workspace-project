...
const FIELD_LABELS: Record<string, { label: string; note: string }> = {
  ...
  checkpoint_timeline: { label: "Timeline (Gantt) — checkpoint version", note: "Manually curated week-by-week rows and colours, from the Checkpoint data tab — reviewed rows only" },
