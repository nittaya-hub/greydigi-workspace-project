...
export async function updateProject(
  ...
  revalidatePath("/missions/projects");
  revalidatePath("/missions");
  revalidatePath(`/missions/projects/${currentRef.toLowerCase()}`);
  if (ref.toLowerCase() !== currentRef.toLowerCase()) revalidatePath(`/missions/projects/${ref.toLowerCase()}`);
  revalidatePath("/");
